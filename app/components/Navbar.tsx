...
export default function Navbar() {
  ...
  const navLinks = [
    ...
    { name: 'Offers', href: '/skin-care' },
    { name: 'Products', href: '/body-care' },
    { name: 'Testimonials', href: '/treatments' },
    { name: 'BLOG', href: '/blog' },
      ...
      <nav className="bg-[#F1DECD] px-4 py-3 md:px-8">
        ...
        <div className="flex lg:hidden items-center space-x-4">
          ...
          <button
            ...
            className="text-[#5a4a3a] focus:outline-none"
          ...
          <div className="flex flex-col space-y-3">
            {navLinks.map((link) => (
              <Link
                key={link.name}
                href={link.href}
                className="text-sm font-medium text-[#5a4a3a] hover:text-[#8a6a4a] transition-colors py-2"
